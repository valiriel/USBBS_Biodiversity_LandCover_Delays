...
for (f in fun.names) {
  ...
  load(paste0("USBBS_DataProcessing/vegan_spmatrix_t1_", f, ".rda"))
  load(paste0("USBBS_DataProcessing/vegan_spmatrix_t2_", f, ".rda"))  
  ...
  save(alphas, file="USBBS_DataProcessing/alpha.01.16_", f, ".rda")
