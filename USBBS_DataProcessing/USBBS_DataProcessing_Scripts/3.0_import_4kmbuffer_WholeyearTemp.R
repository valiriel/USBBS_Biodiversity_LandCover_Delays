...
lc.01 <- read.csv("USBBS_DataProcessing/buffer_extracted_data/USBBS_4km_buffer_LC_01.csv")[,-c(1:3)]
lc.16 <- read.csv("USBBS_DataProcessing/buffer_extracted_data/USBBS_4km_buffer_LC_16.csv")[,-c(1:3)]
...
climate <- read.csv("USBBS_DataProcessing/buffer_extracted_data/USBBS_4km_buffer_Climate.csv")[,-c(1:3)]
...
climate <- climate %>%
            transmute(partition=U_S_R_I,
                      ...
                      temp.t1 = (tmean00_me + tmean01_me)/2,
                      temp.t2 = (tmean15_me + tmean16_me)/2,
                      heatmoist.t1 = ((tmean00_me+10)/(ppt00_mean/1000) + (tmean01_me+10)/(ppt01_mean/1000))/2,
...
save(covariates, file="USBBS_DataProcessing/covariates.rda") # save as rda files
