...
write(m.q0.top, "USBBS_Modelling_Delays/USBBS_model_txts/m.q0.top.txt")
...
write(m.q0.notemplag, "USBBS_Modelling_Delays/USBBS_model_txts/m.q0.notemplag.txt")
...
write(m.q0, "USBBS_Modelling_Delays/USBBS_model_txts/m.q0.notemplagtxt")
...
write(m.q0.noiter, "USBBS_Modelling_Delays/USBBS_model_txts/m.q0.noiter.txt")

###########################################################################################
m.q0.linear.iter <- 'model{
...
write(m.q0.linear.iter, "USBBS_Modelling_Delays/USBBS_model_txts/m.q0.lineariter.txt")
