...
c.values <- data.frame("c.pos.urban" = mcmc.final$c.pos.urban, "c.pos.forest" = mcmc.final$c.pos.forest, 
                       ...
                       "c.neg.forest" = mcmc.final$c.neg.forest, "c.neg.grassland" = mcmc.final$c.neg.grassland, 
                       "c.neg.cropland" = mcmc.final$c.neg.cropland, "c.neg.wetland"=mcmc.final$c.neg.wetland, 
                       "c.neg.temp" = mcmc.final$c.neg.temp) # notice no negative urban, as no data available
...
lags <- c("c.pos.urban", "c.pos.forest", "c.pos.grassland", "c.pos.cropland", "c.pos.wetland", "c.pos.temp",
          "c.neg.forest", "c.neg.grassland", "c.neg.cropland", "c.neg.wetland", "c.neg.temp")
...
for(lag in lags) {
  ...
  for (i in 1:n.samples) {
    ...
    # sample a value form the paramter posterior distro
...
w.urban <- ggplot(df.c.pos.urban, aes(x=delta.values)) +  
  ...
  scale_x_continuous(limits = c(-100, 100), breaks = seq(from=-100, to=100, by=25)) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(from = 0, to = 1000, by = 0.25)) + 
  labs (x = "Urban", y = "Delay")

ggsave(plot = w.urban, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltaurban.svg",
       units = "cm", dpi = "retina", width =29.7, height = 21)
ggsave(plot = w.urban, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltaurban.pdf",
       units = "cm", dpi = "retina", width =29.7, height = 21)
...
w.forest <- ggplot(df.c.pos.forest, aes(x=delta.values)) +  
  ...
  scale_x_continuous(limits = c(-100, 100), breaks = seq(from=-100, to=100, by=25)) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(from = 0, to = 1000, by = 0.25)) + 
  labs (x = "Forest", y = "Delay")

ggsave(plot = w.forest, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltaforest.svg",
       units = "cm", dpi = "retina", width =29.7, height = 21)
ggsave(plot = w.forest, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltaforest.pdf",
       units = "cm", dpi = "retina", width =29.7, height = 21)
...
w.cropland <- ggplot(df.c.pos.cropland, aes(x=delta.values)) +  
  ...
  scale_x_continuous(limits = c(-100, 100), breaks = seq(from=-100, to=100, by=25)) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(from = 0, to = 1000, by = 0.25)) + 
  labs (x = "Cropland", y = "Delay")

ggsave(plot = w.cropland, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltacropland.svg",
       units = "cm", dpi = "retina", width =29.7, height = 21)  
ggsave(plot = w.cropland, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltacropland.pdf",
       units = "cm", dpi = "retina", width =29.7, height = 21) 
...
w.grassland <- ggplot(df.c.pos.grassland, aes(x=delta.values)) +  
  ...
  scale_x_continuous(limits = c(-100, 100), breaks = seq(from=-100, to=100, by=25)) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(from = 0, to = 1000, by = 0.25)) + 
  labs (x = "Grassland", y = "Delay")

ggsave(plot = w.grassland, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltagrassland.svg",
       units = "cm", dpi = "retina", width =29.7, height = 21)
ggsave(plot = w.grassland, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltagrassland.pdf",
       units = "cm", dpi = "retina", width =29.7, height = 21)
...
w.wetland <- ggplot(df.c.pos.wetland, aes(x=delta.values)) +  
  ...
  scale_x_continuous(limits = c(-100, 100), breaks = seq(from=-100, to=100, by=25)) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(from = 0, to = 1000, by = 0.25)) + 
  labs (x = "Wetland", y = "Delay")

ggsave(plot = w.wetland, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltawetland.svg",
       units = "cm", dpi = "retina", width =29.7, height = 21)
ggsave(plot = w.wetland, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltawetland.pdf",
       units = "cm", dpi = "retina", width =29.7, height = 21)
...
w.temp <- ggplot(df.c.pos.temp, aes(x=delta.values)) +  
  ...
  theme_bw() + 
  geom_vline(xintercept = 0) +
  scale_x_continuous(limits = c(-4, 4), breaks = seq(from=-50, to=100, by=2)) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(from = 0, to = 1000, by = 0.25)) + 
  labs (x = "Temperature (°C)", y = "Delay")

ggsave(plot = w.temp, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltatemp.svg",
       units = "cm", dpi = "retina", width =29.7, height = 21)
ggsave(plot = w.temp, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~deltatemp.pdf",
       units = "cm", dpi = "retina", width =29.7, height = 21)
...
ggsave(plot = w.all, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~all.svg",
       units = "cm", dpi = "retina", width =29.7 , height = 21)
ggsave(plot = w.all, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/w~all.pdf",
       units = "cm", dpi = "retina", width =29.7 , height = 21)
...
w.panel <- ggarrange(w.urban + rremove("grid"), 
...
ggsave(plot = w.panel, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/PANEL_w~delta.svg",
       units = "cm", dpi = "retina", width =29.7 , height = 21)
ggsave(plot = w.panel, file = "USBBS_Modelling_Output/w~deltavars_plots/2008_w/PANEL_w~delta.pdf",
       units = "cm", dpi = "retina", width =29.7 , height = 21)
