...
parameters {
  ...
  real<lower=0, upper=100> c_pos_urban;
  real<lower=0, upper=100> c_pos_forest;
  real<lower=0, upper=100> c_pos_grass;
  real<lower=0, upper=100> c_pos_crop;
  real<lower=0, upper=100> c_pos_wet;
  //real<lower=0, upper=1> c_pos_lc_q1;
    //real<lower=0, upper=1> c_neg_urban;
    real<lower=0, upper=100> c_neg_forest;
    real<lower=0, upper=100> c_neg_grass;
    real<lower=0, upper=100> c_neg_crop;
    real<lower=0, upper=100> c_neg_wet;
