...
# Temperature calculated as the mean across May and July for each pair of years 
# from which bird abundances were taken from (2000/2001 and 2015/2016)

#' * Data from Daymet, 1km gridded data, monthly average min and max temperature
